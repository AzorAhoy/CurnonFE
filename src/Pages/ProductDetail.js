...
class ProductDetail extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:6969/api/product/${id}`)
            .then(response => {
        ...
        axios.get(`http://localhost:6969/api/comment/${id}`)
            .then(response => {
                if (response.data.success) {
                    console.log(response.data.data);
                    this.setState({
            ...
            <div>
                ...
                <div className="container m-3 rounded">
                    <div className="row">
                        ...
                        <div className="col">
                            <ProductSummary name={product.title} type={product.type_product} price={product.price} reviews={cmnts.length} desc={product.description} />
                        </div>
